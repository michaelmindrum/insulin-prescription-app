...
if is_new_rx == "Yes" and insulin_type in RAPID_ACTING_INSULINS:
    ...
    prescription_text = (
        ...
        f"As needed: {snack_dose}-{snack_range_high} units, adjusted based on carbohydrate intake and historic response for snacks to achieve post-snack glucose of 5-10 mmol/L.\n"
